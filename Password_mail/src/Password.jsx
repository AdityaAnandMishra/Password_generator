        ...
        <>
            <div className="password">
                <div
                    ...
                    <h1 className="text-base/7 font-semibold dark:text-white">Customization option</h1>
                    <div className='flex flex-col text-sm gap-x-2'>
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <label className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Default
                                checkbox</label>
                        </div>
                        <div className="flex items-center mb-4">
                            <input id="default-checkbox" type="checkbox" value=""
